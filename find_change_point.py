...
if __name__=='__main__':
    inPath='E:/python/audio/wav/201710162100/201710162100.wav'
    outPath='E:/python/audio/wav/201710162100/201710162100.npy'
    
    frame_point,y,fs=silence_point(inPath)
    detected_point=BIC_basded_check(frame_point,y,fs)
    np.save(outPath,detected_point)
